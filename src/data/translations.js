  ...
  en: {
    ...
    valueProposition: {
      included: {
        ...
        items: ["American breakfast", "Free WiFi", "Private parking", "Hot water", "Smart TV"]
      }
    },
    gallery: {
    ...
    roomsPreview: {
      ...
      single: {
        name: "Single Room",
        price: "40",
        features: ["Private bathroom", "Smart TV", "Garden view"]
      },
      deluxe: {
      ...
      twin: {
        name: "Twin Room",
        price: "60",
        features: ["2 single beds", "Smart TV", "Garden view"]
      },
      family: {
    ...
    reviews: {
      ...
      rating: "Exceptional on Booking.com",
    ...
    location: {
      ...
      transport: "Airport shuttle available (paid service)",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Yes! Free cancellation up to 24 hours before arrival. After that, one night will be charged."
        },
        {
          q: "Are pets allowed?",
        ...
        {
          q: "Can children stay?",
          a: "Yes! Children under 12 can share the room with breakfast included."
        },
        {
    ...
    rooms: {
      notFound: {
        ...
        subtitle: "The room you're looking for doesn't exist"
      },
  ...
  es: {
    ...
    valueProposition: {
      included: {
        ...
        items: ["Desayuno americano", "WiFi gratis", "Estacionamiento privado", "Agua caliente", "Smart TV"]
      }
    },
    gallery: {
    ...
    reviews: {
      ...
      rating: "Excepcional en Booking.com",
    ...
    location: {
      ...
      transport: "Transporte desde aeropuerto disponible (servicio pagado)",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "¡Sí! Cancelación gratuita hasta 24 horas antes de la llegada. Después, se cobrará una noche."
        },
        {
        ...
        },
        {
          ...
          a: "¡Sí! Niños menores de 12 años pueden compartir la habitación con desayuno incluido."
        },
        {
          q: "¿Se permite fumar?",
    ...
    rooms: {
      notFound: {
        ...
        subtitle: "La habitación que buscas no existe"
      },
      ...
      nonSmoking: "Habitación para no fumadores",
